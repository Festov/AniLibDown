...
- **Онлайн-просмотр** — HLS-плеер (480p / 720p / 1080p), смена серий, перемотка двойным тапом, пропуск OP/ED, автозапуск следующей серии, запоминание позиции
...
- **Shikimori** — подключение аккаунта, привязка релиза к тайтлу, статусы (Смотрю / Просмотрено / Брошено и др.)
