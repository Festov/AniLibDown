...
- **Карточка релиза** — описание, жанры, серии, связанные тайтлы, скачивание всех серий; тап по постеру для просмотра крупнее; кнопки «Смотреть» и «Коллекции» в одной строке
- **Онлайн-просмотр** — HLS-плеер (480p / 720p / 1080p), смена серий, перемотка двойным тапом, ускорение при удержании (1,5× / 2×), пропуск OP/ED, автозапуск следующей серии, запоминание позиции
- **Офлайн-загрузки** — скачивание серий и просмотр без сети, группировка по аниме, локальные постеры, отмена загрузки с прогрессом
- **Авторизация** — вход в аккаунт AniLiberty, профиль, коллекции (Смотрю / Запланировано / Просмотрено и др.)
- **Shikimori** — подключение аккаунта, привязка релиза к тайтлу, статусы (Смотрю / Просмотрено / Брошено и др.); привязки хранятся локально на устройстве
- **Профиль** — тема, заставка при запуске, качество по умолчанию, версия приложения
- **Тема** — светлая, тёмная или системная; акцент AniLibria (красный)

## Что нового в 1.0.2

Краткий список изменений: [`RELEASE_1.0.2.md`](RELEASE_1.0.2.md)  
Чек-лист для тестирования: [`TESTING_1.0.2.md`](TESTING_1.0.2.md)
...
3. Перетащите `AniLibDown.ipa` в окно Sideloadly или выберете через "Выбор .ipa".
4. Выберете свой Apple ID (первый раз попросит пароль от вашей учетной записи)
5. Выберете свое устройство.
6. Нажмите **Start** и дождитесь завершения установки
