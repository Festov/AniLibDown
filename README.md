...
- Можно соединить через Wi-Fi и приложение будет переустанавливаттся само раз в неделю, когда устройство будет подключено в общую сеть.
