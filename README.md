...
- **Каталог и новинки** — просмотр аниме, поиск и фильтры по жанрам и статусу выхода
- **Карточка релиза** — описание, жанры, список серий, связанные тайтлы, скачивание
- **Онлайн-просмотр** — HLS-плеер с выбором качества, сменой серий, перемоткой, пропуском OP/ED и продолжением с места остановки
...
- **Настройки** — тема оформления, качество видео, параметры плеера
